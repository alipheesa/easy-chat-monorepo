...
export const DialogContent = forwardRef<
  HTMLDivElement,
  React.HTMLProps<HTMLDivElement> & { disableBlur?: boolean; zIndex?: number }
>(function DialogContent({ zIndex = 101, ...props }, propRef) {
    ...
    <FloatingPortal>
      ...
      >
        <FloatingOverlay
          ...
          bg-transparent backdrop-brightness-50 backdrop-blur-[1px]`
          }
          style={{ zIndex: zIndex }}
          lockScroll
        >
